...
import com.obrigada_eu.poika.player.data.infra.utils.DeletableFileImpl
import java.io.File
...
class FileResolver {
     ...
     */
    fun resolveDeletable(base: File, folder: String): DeletableFile =
        DeletableFileImpl(File(base, folder))
}